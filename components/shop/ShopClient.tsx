 ...
 */
export function ShopClient({ view, tileSlugs }: { view: ShopView; tileSlugs: string[] }) {
  const searchParams = useSearchParams();
  const categorySlug = searchParams.get("category");

  return (
    <div>
      <CategoryTiles categories={view.categories} activeSlug={categorySlug} tileSlugs={tileSlugs} />
      ...
      <div className="mt-8 flex flex-col gap-6 lg:flex-row lg:items-start lg:gap-8">
        <FilterSheet categories={view.categories} brands={view.brands} />
        <ShopResults
