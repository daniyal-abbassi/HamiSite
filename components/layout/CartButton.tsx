  ...
  return (
    ...
    >
      ...
      {itemCount > 0 && (
        <span
          aria-hidden="true"
          className="absolute -end-0.5 -top-0.5 grid h-[18px] min-w-[18px] place-items-center rounded-full bg-aqua px-1 font-mono text-xs font-bold text-primary-foreground"
        >
