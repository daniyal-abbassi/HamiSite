    ...
    return (
      ...
      >
        <div className="lg:max-w-xl">
          {eyebrow && (
            <span className="mb-3 block font-mono text-[11px] tracking-[0.18em] text-aqua/70">{eyebrow}</span>
          )}
    ...
    return (
      <div className={cn("", className)}>
        <div className="flex items-center gap-4">
          {index && <span className="font-mono text-[11px] tracking-[0.2em] text-aqua/70">{index}</span>}
          {eyebrow && (
            <span className="font-mono text-[11px] tracking-[0.18em] text-muted-foreground">{eyebrow}</span>
          )}
